...
namespace First\Grid\Controller\Adminhtml\Allnews;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        $this->allnewsFactory = $allnewsFactory
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\First\Grid\Model\AllnewsFactory::class);
        $this->allnewsRepository = $allnewsRepository
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\First\Grid\Api\AllnewsRepositoryInterface::class);
